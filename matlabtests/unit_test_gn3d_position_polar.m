function unit_test_gn3d_position_polar()
% =========================================================================
% ЮНИТ-ТЕСТ: АТОМАРНАЯ ПРОВЕРКА ФУНКЦИИ GN3D_POSITION_POLAR ТИС
% Path: d:\workspace\libtr\matlabtests\unit_test_gn3d_position_polar.m
% =========================================================================

fprintf('ЗАПУСК АТОМАРНОГО ЮНИТ-ТЕСТА ДЛЯ ФУНКЦИИ: gn3d_position_polar\n');
...
for criteria_idx = 1:5
    ...
    for r_idx = 1:8
        ...
        [status, lambda] = gn3d_position_polar(P_exp, alpha, beta);
    ...
    service_print_atomic_report(criteria_idx, range_steps, rmse_results, crlb_results, mock_delta, 'GN_Polar');
end
end
