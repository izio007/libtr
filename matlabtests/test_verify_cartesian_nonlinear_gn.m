function [fixed, summary] = test_verify_cartesian_nonlinear_gn(STATION_COUNTS_VECTOR, FIXED_N_STATIONS, STATION_X_ANCHORS, STATION_Y_ANCHORS, STATION_Z_ANCHORS, x_true, y_true, z_true, DOA_ERROR_DEGREE, RANDOM_SEED)
% =========================================================================
% ВЕРИФИКАТОР: КЛАССИЧЕСКИЙ ДЕКАРТОВ GAUSS-NEWTON (ИЗ УЧЕБНИКА)
% Path: d:\workspace\libtr\matlabtests\test_verify_cartesian_nonlinear_gn.m
% =========================================================================
...
for s_idx = 1:L_counts
    ...
    for k = 1:TRAJECTORY_POINTS_COUNT
        ...
        if st_p == 0
            ...
            [st_c, sx, sy, sz] = gn3d_covariance_cartesian(STATION_POSITIONS, VAR_ALPHA, VAR_BETA, lambda);
            if st_c == 0
